...
func (w *WildcardResolver) GetCertificate(subject string, altNames []string) (*tls.Certificate, error) {
	return w.upstream.GetCertificate(w.applyWildcard(subject), w.applyWildcards(altNames))
}
